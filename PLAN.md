...
Now:     T-001 — amended 2026-09-05 (trapezoid release model + 20 s floor) on feature/T-001-checkservos-release-timeout; tests + both builds green; bench verify + PR pending
Next:    T-002 (channels per-instance), then T-003 (state locking; depends on T-002)
Blocked: none
Last:    2026-09-05 — T-001 amended: accel-as-speed model was a dimensional error (4-min deadlines); replaced with physical trapezoid + floor
