...
Now:     T-003 — implemented on `feature/T-003-maestro-channel-state-sync` (stateMutex + per-operation send mutex + bounded send take); PR-toolkit reviewed, findings fixed; bench + PR pending
