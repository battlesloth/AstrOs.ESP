...
public:
    ...
    static std::string getBasicAckNak(AstrOsSerialMessageType type, std::string msgId, std::string controller, std::string data);

    // methods for testing, these messages are generated by the web server
    static std::string getRegistrationSync(std::string msgId);
    static std::string getDeployConfig(std::string msgId, std::vector<std::string> controllers, std::vector<std::string> configs);
