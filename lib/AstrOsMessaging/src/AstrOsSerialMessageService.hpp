...
public:
    ...
    static std::string getPollAck(std::string macAddress, std::string controller, std::string fingerprint);
    static std::string getPollNak(std::string macAddress, char *controller);
    static std::string getBasicAckNak(AstrOsSerialMessageType type, std::string msgId, std::string macAddress, std::string controller, std::string data);

    // methods for testing, these messages are generated by the web server
    static std::string getRegistrationSync(std::string msgId);
    static std::string getDeployConfig(std::string msgId, std::vector<std::string> macs, std::vector<std::string> controllers, std::vector<std::string> configs);
